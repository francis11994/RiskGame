...
public class RiskMap implements Serializable {
	...
	private Country WESTERNUNITEDSTATES = new Country("Western United States",CountryType.NORTHAMERICA,184*2/3,244*2/3);
	private Country EASTERNUNITEDSTATES = new Country("Eastern United States",CountryType.NORTHAMERICA,282*2/3,262*2/3);
   ...
   //     ARGENTINA.addNeighbour(EASTERNAUSTRALIA);
        ...
        EGYPT.addNeighbour(WESTERNEUROPE);
